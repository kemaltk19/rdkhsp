...
import type { ProjectCategory } from '@/stores/project_category'
...
const handleUpdateCategory = async () => {
  ...
  try {
    await categoryStore.updateCategory(editingCategoryId.value, { name: editingCategoryName.value })
...
<template>
  <div class="project-categories-tab">
    <div class="mb-4">
    ...
    <DataTable :value="categoryStore.categories" class="p-datatable-sm w-full" responsiveLayout="scroll">
